...
export function ProfileView(props) {
	...
	const getUser = () => {
		axios.get(`https://cold-myflix-app.herokuapp.com/users/${currentUser}`, {
	...
	const handleDelete = () => {
		axios.delete(`https://cold-myflix-app.herokuapp.com/users/${currentUser}`, {
			headers: { Authorization: `Bearer ${token}` }
		})
			.then(() => {
	...
	return (
		<Container id="profile-form">
			<Row><h4>Your Profile Information</h4></Row>
			<Row>
			...
			<Row className="mt-5"><h4>Favorite Movies</h4></Row>
			<Row className="mt-3">
				<FavoriteMoviesView
					movies={movies}
